...
//        While developing any application or program, it is always better to catch the bug/problem at
//        the compile-time instead of runtime so that we can provide a smooth experience to the user.
...
//Output :
//        [10, Harry Bhai!, 20.4]
//        In the above code, notice that we can store any type of object in a collection without Generics. But, this is not the case with the Generics.
//        It allows us to store only one type of object. Take a look at the example given below :
//
//        import java.util.ArrayList;
//
//public class CWH {
...
//        Let's suppose you created an ArrayList(without using Generics), and you want to store the value at index 0 into an integer variable named "x."
//        Are you allowed to do this in Java? The answer is a big NO! This is because the ArrayList returns an object,
//        but we're storing the value in an integer variable. In such cases, we need to type-cast the object into our desired data type.
//        But, if we use Generics, then there is no need to typecast. Take a look at the below example to get a better understanding :
//        import java.util.ArrayList;
//
//public class CWH {
//    public static void main(String[] args) {
