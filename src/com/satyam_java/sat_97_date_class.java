...
//        Answer: Yes, it is absolutely safe to store the number of milliseconds in a variable of type long because the maximum value that can be stored in long is 9223372036854775807.
//        You can see that the maximum value of long is huge. Therefore, we do not need to worry about the value of milliseconds.
//        Notice the output of the below code; the value of current time in millisecond is 10^6 times smaller than the maximum value of long data type.
//
//        Example :
//import java.util.*;
...
public class sat_97_date_class {
    public static void main(String[] args) {
