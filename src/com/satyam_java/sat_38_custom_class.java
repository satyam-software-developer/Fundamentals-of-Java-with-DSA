...
public class sat_38_custom_class {
    public static void main(String[] args) {
        System.out.println("This is our custom class");
        Employe harry = new Employe(); // Instantiating a new Employee Object
        Employe john = new Employe(); // Instantiating a new Employee Object
