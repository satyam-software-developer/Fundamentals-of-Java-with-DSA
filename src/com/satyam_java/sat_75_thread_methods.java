...
//        The interrupt() method will not throw the InterruptedException if the thread is not in the sleeping/blocked state,
...
//    }
//}
//    Here the thread works normally because no exception occurred during the thread's execution,
//        so the interrupt() only sets the value of the thread flag to true.
//
//        Output :
//        0
//        1
...
public class sat_75_thread_methods {
    public static void main(String[] args){
